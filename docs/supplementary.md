...
| Down Weighted Multiplicative Log           | Multiplicative Log but normalizes by the number of PSMs per protein. This method attempts to normalize small and large proteins. In a typical multiplicative log a larger protein would have an advantage at having a higher score than a small protein.                                                                                                                                                 |
| Iterative Down Weighted Multiplicative Log | Multiplicative Log but normalizes by the number of PSMs per protein in an iterative fashion. The more psm scores a protein has at each iteration each psm score will impact the overall protein score less and less. This method attempts to normalize small and large proteins. In a typical multiplicative log a larger protein would have an advantage at having a higher score than a small protein. |
