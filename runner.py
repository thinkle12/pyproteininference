...
for i in range(len(list_of_searchids)):
    for st in score_type:
        with PdfPages('/Users/hinklet/random_analysis/brd_analysis/plots/'+list_of_searchids[i]+'_plot_'+st+'_'+scoring_methods[0]+'.pdf') as pdf:
                ...
                for pnp in pick_nopick:
                    for qvr in qvalue_restriction:
                        for pvr in pepvalue_restriction:
                            ...
                            pep_and_prot_data = ProteinInference.reader.PercolatorRead(target_file='/Users/hinklet/random_analysis/brd_analysis/percolator_output_all/'+list_of_searchids[i]+'_percolator_target_psm.txt',
                                                                                      decoy_file='/Users/hinklet/random_analysis/brd_analysis/percolator_output_all/'+list_of_searchids[i]+'_percolator_decoy_psm.txt')
                            ...
                            output = ProteinInference.export.CsvOutAll(data_class=data, filename_out='/Users/hinklet/random_analysis/brd_analysis/pi_output/all_'+scoring_methods[k]+'_'+list_of_searchids[i]+'_'+st+'_all_psms.csv')
                            output.execute()

                            output_leads = ProteinInference.export.CsvOutLeads(data_class=data, filename_out='/Users/hinklet/random_analysis/brd_analysis/pi_output/leads_'+scoring_methods[k]+'_'+list_of_searchids[i]+'_'+st+'_all_psms.csv')
                            output_leads.execute()

                            output_csep = ProteinInference.export.CsvOutCommaSep(data_class=data,filename_out='/Users/hinklet/random_analysis/brd_analysis/pi_output/csep_'+scoring_methods[k]+'_'+list_of_searchids[i]+'_'+st+'_all_psms.csv')
                            output_csep.execute()

                            qval_out_csep = ProteinInference.export.CsvOutCommaSepQValues(data_class=data, filename_out='/Users/hinklet/random_analysis/brd_analysis/pi_output/qvalues_csep_'+scoring_methods[k]+'_'+list_of_searchids[i]+'_'+st+'_all_psms.csv')
                            qval_out_csep.execute()

                            qval_out_all = ProteinInference.export.CsvOutAllQValues(data_class=data,filename_out='/Users/hinklet/random_analysis/brd_analysis/pi_output/qvalues_all_' +scoring_methods[k] + '_' +list_of_searchids[i] + '_' + st + '_all_psms.csv')
                            qval_out_all.execute()

                            qval_out_leads = ProteinInference.export.CsvOutLeadsQValues(data_class=data,filename_out='/Users/hinklet/random_analysis/brd_analysis/pi_output/qvalues_leads_' +scoring_methods[k] + '_' +list_of_searchids[i] + '_' + st + '_all_psms.csv')
