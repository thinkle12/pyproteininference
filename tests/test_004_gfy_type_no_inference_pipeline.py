...
LEAD_OUTPUT_FILE = resource_filename('protein_inference', '../tests/output/leads/test_no_inference_q_value_leads_ml_posterior_error_prob.csv')
ALL_OUTPUT_FILE = resource_filename('protein_inference', '../tests/output/all/test_no_inference_q_value_all_ml_posterior_error_prob.csv')
PEPTIDE_OUTPUT_FILE = resource_filename('protein_inference', '../tests/output/peptides/test_no_inference_q_value_leads_peptides_ml_posterior_error_prob.csv')
PSM_OUTPUT_FILE = resource_filename('protein_inference', '../tests/output/psms/test_no_inference_q_value_leads_psms_ml_posterior_error_prob.csv')
PSM_ID_OUTPUT_FILE = resource_filename('protein_inference', '../tests/output/psm_ids/test_no_inference_q_value_leads_psm_ids_ml_posterior_error_prob.csv')
