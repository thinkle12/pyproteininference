...
LEAD_OUTPUT_FILE = resource_filename('protein_inference', '../tests/output/leads/test_multiplicative_q_value_leads_ml_example_multiplicative_score.csv')
ALL_OUTPUT_FILE = resource_filename('protein_inference', '../tests/output/all/test_multiplicative_q_value_all_ml_example_multiplicative_score.csv')
PEPTIDE_OUTPUT_FILE = resource_filename('protein_inference', '../tests/output/peptides/test_multiplicative_q_value_leads_peptides_ml_example_multiplicative_score.csv')
PSM_OUTPUT_FILE = resource_filename('protein_inference', '../tests/output/psms/test_multiplicative_q_value_leads_psms_ml_example_multiplicative_score.csv')
PSM_ID_OUTPUT_FILE = resource_filename('protein_inference', '../tests/output/psm_ids/test_multiplicative_q_value_leads_psm_ids_ml_example_multiplicative_score.csv')
...
logger = logging.getLogger("protein_inference.tests.test_010_multiplicative_custom_pipeline.py")
...
class TestMultiplicativeWorkflow(TestCase):
    ...
    def test_workflow_multiplicative_custom(self):
        ...
        pipeline = protein_inference.pipeline.ProteinInferencePipeline(parameter_file=PARAMETER_FILE_MULTIPLICATIVE,
                                                                       database_file=TEST_DATABASE,
                                                                       target_files=TARGET_FILE_MULTIPLICATIVE,
                                                                       decoy_files=DECOY_FILE_MULTIPLICATIVE,
                                                                       combined_files=None,
