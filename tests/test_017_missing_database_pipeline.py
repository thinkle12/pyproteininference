...
logger = logging.getLogger("protein_inference.tests.test_017_test_missing_database_pipeline")
...
class TestMissingDatabasePipeline(TestCase):
    ...
    def test_missing_database_pipeline(self):
        ...
        self.assertDictEqual(digest.peptide_to_protein_dictionary,{'CQTCGYKFHEHCSTK': {'RAF1_HUMAN|P04049'}, 'WHGDVAVKILK': {'RAF1_HUMAN|P04049'}, 'QTAQGMDYLHAK': {'ARAF_HUMAN|P10398', 'BRAF_HUMAN|P15056', 'RAF1_HUMAN|P04049'}, 'SASEPSLHR': {'ARAF_HUMAN|P10398', 'RAF1_HUMAN|P04049'}, 'VFLPNKQR': {'BRAF_HUMAN|P15056', 'RAF1_HUMAN|P04049'},
                                                                   'GYLSPDLSK': {'ARAF_HUMAN|P10398', 'BRAF_HUMAN|P15056'}, 'TFFSLAFCDFCLK': {'ARAF_HUMAN|P10398'}, 'FQMFQLIDIAR': {'RAF1_HUMAN|P04049'}, 'LYLLTQMPH': {'TCAF1_HUMAN|Q9Y4C2'}, 'YCWMSTGLYIPGR': {'TCAF1_HUMAN|Q9Y4C2'}, 'AEGGGGGGRPGAPAAGDGK': {'HNRPU_HUMAN|Q00839', 'B3KX72_HUMAN|B3KX72'},
                                                                   'LQAALDDEEAGGRPAMEPGNGSLDLGGDSAGR': {'Q96BA7_HUMAN|Q96BA7', 'HNRPU_HUMAN|Q00839', 'B3KX72_HUMAN|B3KX72'}, 'CGVEVTQTK': {'RPOC_SHIF8|Q0SY12'}, 'IALASPDMIR': {'RPOC_SHIF8|Q0SY12'}, 'MGAEAIQALLK': {'RPOC_SHIF8|Q0SY12'}, 'RVDYSGR': {'RPOC_SHIF8|Q0SY12'}, 'VIDIWAAANDR': {'RPOC_SHIF8|Q0SY12'},
                                                                   'EGLNVLQYFISTHGAR': {'RPOC_SHIF8|Q0SY12'}, 'FATSDLNDLYR': {'RPOC_SHIF8|Q0SY12'}, 'IPQESGGTK': {'RPOC_SHIF8|Q0SY12'}, 'LIPAGTGYAYHQDR': {'RPOC_SHIF8|Q0SY12'}, 'NTLLHEQWCDLLEENSVDAVK': {'RPOC_SHIF8|Q0SY12'}, 'VADLFEAR': {'RPOC_SHIF8|Q0SY12'}, 'VTAEDVLKPGTADILVPR': {'RPOC_SHIF8|Q0SY12'},
                                                                   'HPMQTLLYLK': {'##TCAF1_HUMAN|##Q9Y4C2'}, 'MEPTPVPFCGAK': {'##TCAF2_HUMAN|##A6NFQ2'}, 'TVVNVR': {'RAF1_HUMAN|P04049'}})

        self.assertDictEqual(digest.protein_to_peptide_dictionary,{'RAF1_HUMAN|P04049': {'CQTCGYKFHEHCSTK', 'FQMFQLIDIAR', 'SASEPSLHR', 'VFLPNKQR', 'TVVNVR', 'WHGDVAVKILK', 'QTAQGMDYLHAK'}, 'ARAF_HUMAN|P10398': {'GYLSPDLSK', 'SASEPSLHR', 'TFFSLAFCDFCLK', 'QTAQGMDYLHAK'},
                                                                   'BRAF_HUMAN|P15056': {'GYLSPDLSK', 'VFLPNKQR', 'QTAQGMDYLHAK'}, 'TCAF1_HUMAN|Q9Y4C2': {'LYLLTQMPH', 'YCWMSTGLYIPGR'}, 'HNRPU_HUMAN|Q00839': {'LQAALDDEEAGGRPAMEPGNGSLDLGGDSAGR', 'AEGGGGGGRPGAPAAGDGK'},
                                                                   'B3KX72_HUMAN|B3KX72': {'LQAALDDEEAGGRPAMEPGNGSLDLGGDSAGR', 'AEGGGGGGRPGAPAAGDGK'}, 'Q96BA7_HUMAN|Q96BA7': {'LQAALDDEEAGGRPAMEPGNGSLDLGGDSAGR'},
                                                                   'RPOC_SHIF8|Q0SY12': {'RVDYSGR', 'VIDIWAAANDR', 'IPQESGGTK', 'EGLNVLQYFISTHGAR', 'LIPAGTGYAYHQDR', 'IALASPDMIR', 'FATSDLNDLYR', 'VADLFEAR', 'VTAEDVLKPGTADILVPR', 'CGVEVTQTK', 'NTLLHEQWCDLLEENSVDAVK', 'MGAEAIQALLK'},
                                                                   '##TCAF1_HUMAN|##Q9Y4C2': {'HPMQTLLYLK'}, '##TCAF2_HUMAN|##A6NFQ2': {'MEPTPVPFCGAK'}})
