...
PARAMETER_FILE = resource_filename("py_protein_inference", "../tests/data/test_params_parsimony_pulp_none_types.yaml")
...
logger = logging.getLogger("py_protein_inference.tests.test_020_parsimony_pipeline_glpk_none_type_params.py")
...
class TestLoadParsimonyGlpkNoneTypeParamsWorkflow(TestCase):
    ...
    def test_workflow_parsimony_glpk_none_type(self):
        ...
        self.assertEqual(protein_inference_parameters.tag, "test_parsimony_no_grouping")
